...
<html lang="en">
  ...
  <body>
      ...
      <section id="navbar">
        <div class="container">
          <div class="manubar" id="fixedNav" class="">
            ...
            ></a>
            <a
              href="./donateBlood.html"
              title="রক্তের জন্য পোস্ট সমূহ"
              class="active"
              ><i
              ...
              ></i
            ></a>
            <a href="./bloodSearch.html" title="রক্ত খুজুন"
              ><i
    ...
    <div class="container body-container" id="body-container">
      <!-- post section -->
      <div
        class="post-section pointer-event"
        title="ক্লিক করুন"
      ...
      <div class="newsfeed">
        <div class="card">
          ...
          <div class="footer">
            ...
            <div class="sms">
              <a href="sms:+8801749931891?&body=আসসালামুআলাইকুম,..."
                ><i class="fa-solid fa-comment-dots"></i
                ><span>এস.এম.এস</span></a
              >
            </div>
            <div class="email">
              <a href="mailto:ashraf.uzzaman04082004@gmail.com"
