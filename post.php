        ...
        <div class="container">
          <div class="manubar" id="fixedNav" class="">
            ...
            <a href="./bloodSearch.html" title="রক্ত খুজুন"
              ...
              ></i
            ></a>
            <a href="./post.html" title="পোস্ট করুন" class="active"
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form>
                ...
                <div class="mb-4">
                  <img
                    src="./images/blank_photo.png"
                    width="100"
                    height="100"
                    style="object-fit: cover; border-radius: 10%"
                    alt=""
                  />
                  <label for="photo" style="cursor: pointer" title="ক্লিক করুন"
                ...
                <div class="form-outline mb-4">
                  ...
                  <label class="form-label" for="message"
                    >কার্যক্রম সম্পর্কে লিখুন</label
                  >
                </div>
