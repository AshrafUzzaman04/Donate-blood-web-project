  ...
  <body>
      ...
      <header>
        <div class="container">
          ...
          <div class="manubar">
            ...
            <!-- manubar icon -->
            <div
              class="mobile-navbar d-flex justify-content-center align-items-center text-white"
    ...
    <div class="svg-top" style="z-index: -1">
      <svg
        ...
        fill="none"
        style="color: #aa3333; position: relative; top: 0; display: block"
    ...
    <div class="container p-0">
      ...
      <section class="help my-3 my-lg-5">
        <div
          class="row m-0 flex-column-reverse text-center text-lg-start flex-lg-row"
        >
          <div class="text col-12 col-lg-6 px-4">
            <span class="display-5"
              >রক্তদানে সাহায্য করার জন্য স্বেচ্ছাসেবকদের প্রয়োজন</span
            >
            <p>
          ...
          <div class="img col-12 col-lg-6">
            <img
              src="./images/VeectezyActivism-WorldBloodDonorDay-Illustrationbv0421_generated-removebg-preview.png"
              alt=""
              class="img-fluid"
            />
          </div>
    ...
    <footer class="text-center text-lg-start bg-white text-muted">
          ...
          >
            ...
            <div class="mt-3 mt-md-4 mb-3">
              ...
              <div class="mobile-app-link">
                <a href="javascript:void(0)"
                  ><img
                    src="./images/Google_Play-Badge-Logo.wine.png"
                    alt=""
                ...
                <a href="javascript:void(0)"
                  ><img
                    src="./images/App_Store_(iOS)-Badge-Logo.wine.png"
                    alt=""
                    class="img-fluid m-0 p-0"
                    width="100px"
                /></a>
      ...
      <div class="logo-media" style="background-color: #aa3333e7">
        ...
        >
          <!-- Left -->
          <div
            class="me-5 d-none d-lg-flex justify-content-center align-items-center text-white"
          >
            <span class="vertical-center my-auto py-auto"
              >সামাজিক যোগাযোগ মাধ্যম গুলোতে আমাদের সাথে সংযুক্ত থাকুনঃ</span
            >
          </div>
          <!-- Left -->
          ...
          <div>
            ...
            <!-- Linkedin -->
            <a
              href="https://www.linkedin.com/in/ashrafuzzaman04/"
      ...
      <!-- Copyright -->
      <div
        class="text-center px-4 py-2 border-0 fw-semibold"
    ...
    <a href="#" title="উপরে যান" class="goToTop"
      ><img
