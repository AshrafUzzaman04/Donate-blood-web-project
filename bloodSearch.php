...
<html lang="en">
  ...
  <body>
              ...
              <div class="offcanvas-body">
                ...
                <nav>
                  <ul>
                    ...
                    <li>
                      <a href=""
                        ><ion-icon name="log-out-outline"></ion-icon> লগ আউট</a
                      >
                    </li>
                    <li>
                      <a href=""
      ...
      <section id="navbar">
        <div class="container">
          <div class="manubar" id="fixedNav" class="">
            <a href="./" title="হোমে ফিরুন"
              ><i class="fa-solid fa-house" style="color: #6fb554"></i
            ></a>
            <a href="./donateBlood.html" title="রক্তের জন্য পোস্ট সমূহ"
              ><i
                class="fa-solid fa-hand-holding-droplet"
                style="color: #6fb554"
              ></i
            ></a>
            <a href="./bloodSearch.html" title="রক্ত খুজুন" class="active"
              ><i
                class="fa-solid fa-magnifying-glass"
                style="color: #6fb554"
              ></i
            ></a>
            <a href="./post.html" title="পোস্ট করুন"
              ><i class="fa-solid fa-earth-americas" style="color: #6fb554"></i
            ></a>
          </div>
        </div>
      </section>
    ...
    <div class="container container-body" id="body-container">
      ...
      <!-- search for blood -->
      <div class="search">
        <a href="./bloodGroup.html"><i class="fa-solid fa-droplet"></i>A+</a>
        <a href="./bloodGroup.html"><i class="fa-solid fa-droplet"></i>A-</a>
        <a href="./bloodGroup.html"><i class="fa-solid fa-droplet"></i>B+</a>
        <a href="./bloodGroup.html"><i class="fa-solid fa-droplet"></i>B-</a>
        <a href="./bloodGroup.html"><i class="fa-solid fa-droplet"></i>O+</a>
        <a href="./bloodGroup.html"><i class="fa-solid fa-droplet"></i>O-</a>
        <a href="./bloodGroup.html"><i class="fa-solid fa-droplet"></i>AB+</a>
        <a href="./bloodGroup.html"><i class="fa-solid fa-droplet"></i>AB-</a>
      </div>
    </div>
