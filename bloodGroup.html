  ...
  <body>
    ...
    <header>
      <div class="container">
        ...
        <!-- back to page -->
        <a class="back-to-page" href="./bloodSearch.html">
      ...
      <section
        class="form"
        style="background-color: #f7f7f7; padding-bottom: 10px; border: 0"
      >
    ...
    <div class="container profile-section mx-auto">
      ...
      <div class="card profile mx-auto">
        <a class="img" href="./donatorProfile.html">
          <img src="./images/blank_men.png" alt="" title="প্রফাইল দেখুন" />
        </a>
        <div class="text">
          <a href="./donatorProfile.html" title="প্রফাইল দেখুন"
            >আশরাফ উজ্জামান</a
          >
          <span
            >সর্বশেষ ২৬/০৩/২০২১ তারিখ রক্তদান করেছেন। ৫২৯ দিন পূর্বে করদান করার
            সময় হয়েছে।</span
          >
        </div>
      </div>
